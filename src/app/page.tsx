          ...
          <div className="flex justify-between border border-zinc-200 p-3 rounded-lg bg-zinc-100">
            ...
            <div className="flex items-center justify-center gap-0.5">
              <button className="group flex items-center cursor-pointer justify-center p-1.5 rounded-md hover:bg-zinc-200 transition-colors duration-200">
                <Edit className="w-4 h-4 text-zinc-700 group-hover:text-zinc-900 transition-colors" />
              </button>
              <button className="group flex items-center cursor-pointer justify-center p-1.5 rounded-md hover:bg-zinc-200 transition-colors duration-200">
                <LucideTrash2 className="w-4 h-4 text-zinc-700 group-hover:text-zinc-900 transition-colors" />
              </button>
            </div>
          </div>
        </div>
